...
//   fetch(`${dbUrl}/friends.json?orderBy="uid"&equalTo="${uid}"`)
//     .then((response) => {
//       if (response.data) {
...
//   fetch(`${dbUrl}/friends.json?`, friendObj)
//     .then((response) => {
//       const payload = { friendsFirebaseKey: response.data.name };
//       fetch(`${dbUrl}/friends/${response.data.name}.json`, payload).then(() => {
...
//   fetch(`${dbUrl}/friends/${firebaseKey}.json`)
...
//   fetch(`${dbUrl}/friends/${friendObj.name}.json`, friendObj)
